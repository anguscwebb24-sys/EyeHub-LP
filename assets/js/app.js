...
(function () {
  ...
  function mountBooking(root, idx) {
    ...
    root.innerHTML = `
      ...
      <div class="pane" data-pane="3" aria-live="polite">
        <div class="success">
          ...
          <h4 tabindex="-1">Thanks, <span data-s-name></span>. We've got your request.</h4>
          <p>Our team will call or SMS you from ${CONFIG.clinicPhone} within one business day to confirm your time and send the call details. Save the number so you know it's us.</p>
          <div class="summary">
    ...
    form.addEventListener('submit', async e => {
      ...
      if (form.bk_hp_x7.value) { // honeypot: a bot does not care about the message, a real person gets the phone number
        ...
        msg.innerHTML = `Something went wrong and your request didn't send. Please call us on <a href="tel:0752208990"><b>${CONFIG.clinicPhone}</b></a> and we'll book you in over the phone.`;
        return;
      }
      ...
      try {
        ...
        msg.className = 'form-msg error';
        msg.innerHTML = `Something went wrong and your request didn't send. Please try again, or call us on <a href="tel:0752208990"><b>${CONFIG.clinicPhone}</b></a> and we'll book you in over the phone.`;
      } finally {
  ...
  function initPains(widgets) {
    ...
    const update = () => {
      ...
      nEl.textContent = n;
      msgEl.textContent = n === 0 ? 'Tick the ones that hit home.'
        : n < 3 ? `${n} so far. Be honest.`
        : `${n} ticked. That's ${n} reasons to spend 15 minutes finding out if you can do something about it.`;
